    ...
    <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class='form-control' name='Agama' id='Agama'>
                            <?php 
                                $agama = array("","ISLAM","Kristen", "Hindu","Buddha","Kong Hu Cu");
        ...
        <form id="FormUpload" class='form-horizontal' action='#' enctype='multipart/form-data'>
            ...
            <div class='form-group'>
                ...
                <div class='col-sm-3'>
                    <input type='text' disabled class='form-control' id='UploadNamaCabang' placeholder='Nama Cabang'>
                </div>
            </div>
            ...
            <div class='form-group'>
                ...
                <div class='col-sm-2'>
                    <input type='text' class='form-control' name='Jabatan' id='UploadJabatan' placeholder='Kode Jabatan'>
                </div>
                <div class='col-sm-3'>
                    <input type='text' disabled class='form-control' id='UploadNamaJabatan' placeholder='Nama Jabatan'>
                </div>
            </div>
            ...
            <div class='form-group'>
                ...
                <div class='col-sm-5'>
                    ...
                    <div class="alert alert-info alert-dismissible" role="alert">
                        <strong>INFO</strong> Data yang diupload harus sesuai dengan format yang disediakan sistem. <a href='FormatDataExport/FormatKaryawan.xls' target='_blank' class='btn btn-success btn-xs'><i class='fa fa-download'> Download Format</i></a>
                    </div>
                </div>
            </div>
