...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <input type="hidden" name="IdPendidikan" id="IdPendidikan" value="">

            <div class="form-group">
                <label class="control-label col-sm-2">Kode Pendidikan</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control' readonly name='KodePendidikan' id='KodePendidikan' placholder='Kode Divisi' />
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2">Nama Pendidikan</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control' name='NamaPendidikan' id='NamaPendidikan' placholder='Nama Pendidikan' />
                </div>
            </div>
