    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type='text' class='form-control' onkeyup='StrToUpper(this)' name='NamaJabatan' id='NamaJabatan' placholder='Nama Jabatan' />
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2">Kode Disposisi</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control' onkeyup='StrToUpper(this)' name='KodeDisposisi' id='KodeDisposisi' placholder='Kode Disposisi' />
                </div>
            </div>
