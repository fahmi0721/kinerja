...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <input type="hidden" name="IdLisensi" id="IdLisensi" value="">

            <div class="form-group">
                <label class="control-label col-sm-2">Kode Lisensi</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control' readonly name='KodeLisensi' id='KodeLisensi' placholder='Kode Lisensi' />
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2">Nama Lisensi</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control' name='NamaLisensi' id='NamaLisensi' placholder='Nama Lisensi' />
                </div>
            </div>
