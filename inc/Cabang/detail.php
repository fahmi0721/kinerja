    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type='text' class='form-control' readonly name='KodeCabang' id='KodeCabang' placholder='Kode Cabang' />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type='text' class='form-control' name='NamaCabang' id='NamaCabang' placholder='Nama Cabang' />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                   <textarea class='form-control' id='Alamat' class='form-control' name='Alamat' placeholder='Alamat' rows='3'></textarea>
                </div>
            </div>       
