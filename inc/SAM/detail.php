...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <input type="hidden" name="IdAproveMkp" id="IdAproveMkp" value="">

            <div class="form-group">
                <label class="control-label col-sm-2">Jabatan Aprove</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control'  name='JabatanAprove' id='JabatanAprove' placholder='Jabatan Aprove' />
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2">Jabatan Pembuat RKB</label>
                <div class="col-sm-4">
                    <input type='text' class='form-control' name='JabatanPembuatRKB' id='JabatanPembuatRKB' placholder='Jabatan Pembuat RKB' />
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped" id="TableData">
                    <thead>
                        <tr>
                            ...
                            <th>Jabatan Aprove</th>
                            <th>Jabatan Pembuat RKB</th>
                            <th>Keterangan</th>
