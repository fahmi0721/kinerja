...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <input type="hidden" name="IdKelasJabatan" id="IdKelasJabatan" value="">

            <div class="form-group">
                <label class="control-label col-sm-2">Kelas Jabatan</label>
                <div class="col-sm-3">
                    <input type='text' class='form-control' onkeyup='StrToUpper(this)' placeholder='Kelas Jabatan' id='KelasJabatan' name='KelasJabatan' />
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2">TKO</label>
                <div class="col-sm-4">
                    <div class='input-group'>
                        <span class='input-group-addon'>Rp. </span>
                        <input type='text' class='form-control' placeholder='Tunjangan Kinerja Organisasi' onkeyup="AngkaRupiah(this)" id='TKO' name='TKO' />
                   </div>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-2">TKP</label>
                <div class="col-sm-4">
                    <div class='input-group'>
                        <span class='input-group-addon'>Rp. </span>
                        <input type='text' class='form-control' placeholder='Tunjangan Kinerja Pegawai' onkeyup="AngkaRupiah(this)" id='TKP' name='TKP' />
                   </div>
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped" id="TableData">
                    <thead>
                        <tr>
                            ...
                            <th colspan='2'><center>TUNJANGAN</center></th>
                            <th rowspan='2'>KETERANGAN</th>
                            <th rowspan='2' width="8%"><center>AKSI</center></th>
                        </tr>
                        <tr>    
                            <td><center>KINERJA ORGANISASI</center></td>
                            <td><center>KINERJA PEGAWAI</center></td>
                        </tr>
                    </thead>
                </table>
            </div>
