...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form id="FormData" class="form-horizontal" action="#" enctype='multipart/form-data'>
            ...
            <input type="hidden" name="IdTemplateInvoice" id="IdTemplateInvoice" value="">
            <input type="hidden" name="TmpFile" id="TmpFile" value="">

            <div class="form-group">
                <label class="control-label col-sm-2">Judul Template</label>
                <div class="col-sm-6">
                   <input type='text' class='form-control'  id='JudulTemplate' class='form-control' name='JudulTemplate' placeholder='Enter Judul Template' />
                </div>
            </div>  
            ...
            <div class="form-group">
                <label class="control-label col-sm-2">File Template</label>
                <div class="col-sm-6">
                   <input type='file' class='form-control' accept='.php' id='FileTemplate' class='form-control' name='FileTemplate'  />
                </div>
            </div>
